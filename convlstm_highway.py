...
class Dataloader(Sequence):
    ...
    def __getitem__(self, idx):
        ...
        x_path="D:/npz/batch/x/"
        y_path="D:/npz/batch/y/"
        # print(f"{idx} idx 번호")
        # print(f"{self.data_list[idx]} x 번호")
        return np.load(f"{x_path}{self.data_list[idx]}.npz")['x'] , np.load(f"{y_path}{self.data_list[idx]}.npz")['x']
...
model.save('my_model_test_100_3_mse.h5')